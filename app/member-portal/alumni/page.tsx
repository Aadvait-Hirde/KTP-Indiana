      ...
      <div className="max-w-6xl mx-auto space-y-4 md:space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Connect with KTP alumni and explore career opportunities across top
            companies.
          </p>
        </div>
        ...
        <div className="bg-card rounded-lg border overflow-hidden">
          <div className="p-4 border-b">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Browse our alumni network and their career paths at leading
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Our alumni work at leading tech companies including Google,
                Microsoft, Meta, and more.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                From software engineering to product management, our alumni
                pursue varied career paths.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Reach out to our alumni network via LinkedIn or email and expand
