...
export default function CommunityPage() {
  ...
  const activeMembers = [
    ...
    { name: "Rishi Bhuthpur", major: "Information Systems, Informatics", year: "Sophomore", initials: "RB", image: "/member-headshots/rishi.png" },
    { name: "Amrutha Balla", major: "Finance and Accounting", year: "Junior", initials: "AB", image: "/member-headshots/amrutha.png" },
    { name: "Travis Garcia", major: "Information Systems, Business Analytics", year: "Sophomore", initials: "TG", image: "/member-headshots/travis.png" },
    { name: "Srika Sudheer", major: "Marketing & Digital Technology Management", year: "Junior", initials: "SS", image: "/member-headshots/srika.png" },
    { name: "Ethan Abilius", major: "Finance", year: "Sophomore", initials: "EA", image: "/member-headshots/ethan.png" },
    { name: "Akshay Boddapu", major: "Information Systems, Business Analytics", year: "Junior", initials: "AB", image: "/member-headshots/akshay.png" },
    { name: "Arnav Pydimukkala", major: "Finance", year: "Sophomore", initials: "AP", image: "/member-headshots/arnav.png" },
    { name: "Dhanali Kantilal", major: "Marketing", year: "Sophomore", initials: "DK", image: "/member-headshots/dhanali.png" },
    { name: "Tanya Kalale", major: "Information Systems, Marketing, & Business Analytics", year: "Junior", initials: "TK", image: "/member-headshots/tanya.png" },
    { name: "Vini Premkumar", major: "Information Systems, Operations Management, Business Analytics", year: "Sophomore", initials: "VP", image: "/member-headshots/vini.png" },
    { name: "Veer Nangia", major: "Finance", year: "Sophomore", initials: "VN", image: "/member-headshots/veer.png" },
    { name: "Alexander Balon", major: "Information Systems, Business Analytics", year: "Sophomore", initials: "AB", image: "/member-headshots/alex_balon.png" },
    { name: "Benedict Yiga", major: "Computer Science", year: "Junior", initials: "BY", image: "/member-headshots/benedict.png" },
    { name: "Sankalpa Hedge", major: "Informatics", year: "Junior", initials: "SH", image: "/member-headshots/sankalpa.png" },
  ]
