...
export function MemberPortalSidebar() {
  ...
  //       {/* Sidebar */}
  //       <div
  //         className={`${sidebarClasses} border-r h-screen flex flex-col transition-all duration-300 ${
  ...
  //       className={`${
  //         isCollapsed
  //           ? "px-3 h-12 w-12 justify-center"
  //           : "w-full px-4 justify-start"
  //       } border-zinc-600 hover:bg-zinc-800 text-zinc-300 hover:text-white h-12 flex items-center bg-transparent`}
  //       size="default"
  //     >
