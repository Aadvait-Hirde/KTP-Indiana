        ...
        <div className="mb-16 bg-white dark:bg-white rounded-2xl p-8">
          <div className="space-y-6">
            {companyLogos.map((row, rowIndex) => (
              <div
                key={rowIndex}
                className="flex justify-center items-center gap-4 md:gap-6 lg:gap-8 flex-wrap"
              >
        ...
        <Card className="max-w-2xl mx-auto text-center bg-card dark:bg-card border-border dark:border-border">
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground dark:text-muted-foreground">
              Connect with talented students and help shape the next generation
              of technologists
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://airtable.com/apptTTB2WqRF4M8y7/pagLnzIFluCfywg6q/form",
                    "_blank"
                  )
                }
              >
